	...
	var Headers = React.createClass({
	  ...
	  render: function () {
	    ...
	    var headers = this.props.panes.map(function (pane, idx) {
	      ...
	      return React.createElement(
	        'button',
	        { key: idx, className: klass, onClick: that.props.onTabChosen.bind(null, idx) },
	        pane.title
	      );
	    });
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Headers, { panes: this.props.panes, selectedPane: this.state.selectedTab, onTabChosen: this.selectTab }),
	      React.createElement(
	        'p',
	        null,
	        pane.content
